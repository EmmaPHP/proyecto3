...
class Admin extends SessionController{
    ...
    function newCategory(){
        error_log('Admin::Nueva Categoria()');
        if($this->existsPOST(['name', 'color'])){
            ...
            if(!$categoriesModel->exists($name)){
                ...
                $this->redirect('admin', ['success' => MensajesCorrectos::SUCCESS_ADMIN_NEWCATEGORY]);
            }else{
                $this->redirect('admin', ['error' => MensajesError::ERROR_ADMIN_NEWCATEGORY_EXISTS]);
            }
        }
    }
